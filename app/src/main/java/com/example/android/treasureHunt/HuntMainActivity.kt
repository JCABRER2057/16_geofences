 ...
 */
    ...
    private fun addGeofenceForClue() {
        ...
        //Find out the currentGeofenceIndex using the viewModel. If the index is higher than the number of landmarks we have, it means the user has found all the treasures.
     ...
     * permission.
     */
    //In HuntMainActivity.kt, copy this code into the removeGeofences() method
